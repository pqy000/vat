...
from model.mean_trainer import Model_Teacher
import numpy as np
from model.TCNmodel import TCN
from model.model_backbone import SimConv4, OurConv4
...
def train_Teacher(x_train, y_train, x_val, y_val, x_test, y_test, opt):
    K = opt.K
